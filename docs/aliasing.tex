...
\input{header.tex}
\title{Sampling and Aliasing in 2D}
...
%jupyter nbconvert --to latex_lenvs --LenvsLatexExporter.removeHeaders=True Sampling\ and\ Aliasing.ipynb 
\input{"Sampling and Aliasing.tex"}
